...
func getAPIEnv(api *spec.API, awsClient *aws.Client, gcpClient *gcp.Client) []string {
	...
	envs = append(envs,
        ...
        "CORTEX_DEPENDENCIES_PIP="+api.Predictor.Dependencies.Pip,
        "CORTEX_DEPENDENCIES_CONDA="+api.Predictor.Dependencies.Conda,
        "CORTEX_DEPENDENCIES_SHELL="+api.Predictor.Dependencies.Shell,
